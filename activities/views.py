...
class ScheduleHiddenView(TemplateView):
    template_name = 'activities/schedule_hidden.html'


class ScheduleRealView(TemplateView):
    template_name = 'activities/schedule_real.html'
...
class ActivitySubscribeView(FormView):
    template_name = 'activities/activity_subscribe.html'
...
class ProposalSentView(TemplateView):
    template_name = 'activities/proposal_sent.html'


class ProposalView(FormView):
    template_name = 'activities/proposal.html'
