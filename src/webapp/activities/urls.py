...
urlpatterns = patterns('',
    ...
    url(r'^merethaderthad_actividad_inscribir/(?P<activity_id>\d+)/$', ActivitySubscribeView.as_view(), name='activity-subscribe'),
    url(r'^merethaderthad_actividad_editar/(?P<activity_id>\d+)/$', ActivityEditView.as_view(), name='activity-edit'),
